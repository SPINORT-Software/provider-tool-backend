...
urlpatterns = [
    ...
    path('roles/<str:role_id>', Roles.RolesDetail.as_view()),

    # GET/POST for role permissions
    path('role-permissions/', Roles.RolePermissionList.as_view()),

    # UPDATE/DELETE for role permissions
    path('role-permissions/<str:role_permission_id>', Roles.RolePermissionDetail.as_view()),

    # List Role Permissions by Role ID
    path('role-permissions/role/<str:role_id>', Roles.RolePermissionListByRole.as_view()),
